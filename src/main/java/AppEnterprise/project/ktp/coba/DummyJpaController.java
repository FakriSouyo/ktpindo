...
import AppEnterprise.project.ktp.coba.exceptions.NonexistentEntityException;
import AppEnterprise.project.ktp.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("AppEnterprise_project.ktp_jar_0.0.1-SNAPSHOTPU");
